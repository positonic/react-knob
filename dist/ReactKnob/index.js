...
var _LittlePhatty = _interopRequireDefault(require("./LittlePhatty.png"));
...
var Index = _styledComponents.default.span(_templateObject(), function (props) {
  return props.width + 'px' || '64px';
}, function (props) {
  return props.height + 'px' || '64px';
}, _LittlePhatty.default); //var knobImage = require('./images/LittlePhatty.png');
    ...
    */
    ...
    value: function render() {
      return _react.default.createElement("div", {
        ...
        onClick: this.click
      }, _react.default.createElement(Index, {
